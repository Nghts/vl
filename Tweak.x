...
// upstream's fullscreen/Shorts window-mode check was YouTube-class-name
// based and doesn't apply here, so the indicator just shows unconditionally
// whenever the tweak is enabled)
// ---------------------------------------------------------------------------
